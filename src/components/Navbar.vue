  ...
  data() {
    return {
      ...
      loggedNav: [
        ...
        { divider: true },
        { icon: 'domain', text: 'partnerships', route: '/partnerships', function: this.empty},
        { icon: 'archive', text: 'archive', route: '/home', function: this.empty},
        { icon: 'delete', text: 'trash', route: '/home', function: this.empty},
        { icon: 'keyboard', text: 'keyboardShotcuts', route: '/home', function: this.empty},
        { icon: 'settings', text: 'settings', route: '/home', function: this.empty},
        { divider: true },
